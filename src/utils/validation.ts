 ...
 */
export function validateCalendarDay(day: CalendarDay, dayIndex: number): ValidationResult {
  const errors: string[] = [];
 ...
 */
export function validateCalendarMonth(month: CalendarMonth, monthIndex: number): ValidationResult {
  const errors: string[] = [];
  const warnings: string[] = [];
 ...
 */
export function validateCalendarYear(year: CalendarYear, yearNumber: number): ValidationResult {
  const errors: string[] = [];
  const warnings: string[] = [];
 ...
 */
export function convertNepaliToEnglish(nepaliStr: string): string {
 ...
 */
export function validateScrapedData(data: unknown): ValidationResult {
  const errors: string[] = [];
  const warnings: string[] = [];
  ...
  Object.entries(calendarData).forEach(([yearStr, yearData]) => {
    ...
    const yearValidation = validateCalendarYear(yearData as CalendarYear, yearNumber);
